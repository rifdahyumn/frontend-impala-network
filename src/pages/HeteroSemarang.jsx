...
const HeteroSemarang = () => {
    ...
    const handleDownloadTemplate = useCallback(() => {
        try {
            // Template data untuk import member Hetero Semarang
            const templateData = [
                {
            ...
            link.href = url;
            link.setAttribute('download', `hetero_semarang_import_template_${new Date().getTime()}.csv`);
    ...
    return (
        <div className='flex pt-20 min-h-screen bg-gray-100'>
            <div className='flex-1 p-6'>
                ...
                {/* 🔴 MODIFIKASI: Wrap HeteroContent dengan div yang memiliki ref untuk auto-scroll */}
                <div 
                    ref={memberDetailRef}
                    className={`
