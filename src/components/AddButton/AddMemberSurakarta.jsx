            ...
            fields: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { value: 'Private Office 7-8', label: 'Private Office 7-8' },
                        { value: 'Private Office 1', label: 'Private Office 9' },
                        { value: 'Private Office 1', label: 'Private Office 10' },
                        { value: 'Rembug Meeting Room', label: 'Rembug Meeting Room' },
                        { value: 'Gatra Event Space', label: 'Gatra Event Space' },
                        { value: 'Saka Foodlab', label: 'Saka Foodlab' },
                        { value: 'Abipraya Game Area', label: 'Abipraya Game Area' },
